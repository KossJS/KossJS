...
class TestKossProtocol:
    ...
    def test_import_node_module(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL, builtins=KossJS.KOSS_BUILTIN_NODE | KossJS.KOSS_BUILTIN_KOSS)
        result = koss.eval("""
    ...
    def test_node_builtin_flag_required(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL, builtins=KossJS.KOSS_BUILTIN_BUN+KossJS.KOSS_BUILTIN_KOSS | KossJS.KOSS_BUILTIN_DENO)
    ...
    def test_all_builtins_enabled(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL)  # Default: KOSS_BUILTIN_ALL
    ...
    def test_none_builtins(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL, builtins=KossJS.KOSS_BUILTIN_NONE)
        with pytest.raises(Exception, match="KOSS_BUILTIN_NODE"):
            koss.eval("require('koss:node/fs')")
        koss.destroy()
    ...
    def test_is_builtin_enabled_method(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL, builtins=KossJS.KOSS_BUILTIN_NODE | KossJS.KOSS_BUILTIN_BUN)
    ...
    def test_stable_still_disables_ffi(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL, stable=True, builtins=KossJS.KOSS_BUILTIN_NODE)
    ...
    def test_koss_global_object_version(self):
        ...
        koss = KossJS(capabilities=KossJS.KOSS_CAP_ALL)
